...
void test_euclideanDistance(){
    ...
    try{
        ...
        TEST_CHECK(string(ia.what()) == "Argument Containers are empty");
    };
    ...
    try{
        ...
        TEST_CHECK(string(ia.what()) == "Dimension Mismatch between Arguments");
    };
...
void test_sampleFromSet(){
    ...
    try {
        ...
        TEST_CHECK(string(ia.what()) == "Set is empty.\n");
    }
...
void test_myArgMin(){
    ...
    try{
        ...
        TEST_CHECK(string(ia.what()) == "Query container is empty.\n");
    }
...
void test_closestN(){
    ...
    try{
        ...
        TEST_CHECK(string(ia.what()) == "N must be greater than 0.\n");
    }
